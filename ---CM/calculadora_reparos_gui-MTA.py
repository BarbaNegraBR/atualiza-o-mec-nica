...
class CalculadoraReparosGUI:
    ...
    def setup_data(self):
        ...
        self.todos_itens.update(self.kits)
    ...
    def setup_interface(self):
        ...
        self.categoria_combo = ttk.Combobox(left_frame, textvariable=self.categoria_var, 
                                          values=["Todas", "Peças Individuais", "Kits", "Motores", "Peças Genéricas"],
    ...
    def atualizar_tabela_precos(self):
        ...
        tabela += "\nKITS:\n"
        for item, preco in sorted(self.kits.items()):
            tabela += f"  {item:<20} = $ {preco:,}\n"
